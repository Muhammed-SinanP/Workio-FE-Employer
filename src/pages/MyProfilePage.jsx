...
import profileImg from "../assets/profileAnime.jpg";
      ...
      <div className="innerDiv min-h-screen   p-4">
        {isLoading ? (
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-homeColor-light dark:bg-homeColor-darkMode pt-4 pl-8 pr-10 pb-0 rounded-md flex justify-between gap-2 shadow-sm shadow-gray-500 ">
              ...
              <div className="border  rounded-md p-4">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="text-xs text-gray-600 my-4 dark:text-darkColor-text">
                    Your name is visible to job seekers and admin
                  </div>
                </div>
